// Price : Declaring Pricing variables ↓
...
// Monthly Pricing: Declaring monthly pricing variables ↓
...
// Note that function to switch values between monthly & annually when button is clicked ↓
function priceButtonToggle() {
    if (buttonBall.classList.contains('left')) {
        ...
        premiumDiscountMessage.innerHTML = ``;
        businessDiscountMessage.innerHTML = ``;
